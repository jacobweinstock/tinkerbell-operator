...
import (
	...
	tinkv1 "github.com/jacobweinstock/tinkerbell-operator/api/v1"
...
// +kubebuilder:rbac:groups=tink.tinkerbell.org,resources=hardwares,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=tink.tinkerbell.org,resources=hardwares/status,verbs=get;update;patch
...
func (r *HardwareReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	if instance.Status.Phase == "" {
		instance.Status.Phase = v1.PhasePending
	}
